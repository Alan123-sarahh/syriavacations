      ...
      <div className="sticky top-16  flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg ml-auto">
        <div className="p-6">
          <div className="mb-3 flex items-center justify-between">
            ...
            <p className="flex items-center gap-1 text-base font-normal leading-relaxed text-blue-gray-900 antialiased">
              <svg
          ...
          <div className="group mt-5 inline-flex flex-wrap items-center gap-3">
            <span
              ...
              className=" rounded-full border border-pink-500/5 bg-pink-500/5 p-3 text-[#FF395C] transition-colors  hover:!opacity-100 "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
