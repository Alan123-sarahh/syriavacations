...
export default function BottomNav({ title, id, price }) {
  return (
    <div className="fixed md:hidden right-0 bottom-0  h-[70px] sm:h-20 w-full px-5 bg-white border-t flex flex-col justify-center z-10">
      <div className="flex justify-between items-center">
        <div className="flex flex-row items-center gap-1">
          <div className="font-semibold text-sm relative">{price} sp</div>
          <div className="font-light text-neutral-500">night</div>
        </div>
        <Link
          href={`https://wa.me/963935173587?text=Hi!%20I'm%20interested%20in%20${title}%20(ID%20${id})`}
        >
          <button
